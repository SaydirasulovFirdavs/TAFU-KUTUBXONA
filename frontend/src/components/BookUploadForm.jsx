    ...
    useEffect(() => {
        if (initialData) {
            setFormData({
                ...
                category_ids: Array.isArray(initialData.category_ids) ? initialData.category_ids : [],
                new_category_name: '',
            ...
            <form onSubmit={handleSubmit} className="upload-form-grid">
                ...
                <div className="details-form-section">
                    ...
                    <div className="form-footer-action">
                        {/* File Attachment */}
                        <div
                            className={`file-attachment-box ${file || (initialData && initialData.file_path) ? 'has-file' : ''}`}
                            onClick={() => fileInputRef.current?.click()}
                            title={file ? file.name : (initialData?.file_path ? t('admin.file_exists') : t('admin.select_file'))}
                        >
                            <input
                                type="file"
                                ...
                                className="hidden-input"
                            />
                            <span className="attach-icon">{file || (initialData && initialData.file_path) ? '✅' : '📎'}</span>
                            <span>
                                {file
                                    ? t('admin.selected')
                                    : (initialData?.file_path ? t('admin.edit_change_file') : t('admin.select'))
                                }
                            </span>
                        </div>
