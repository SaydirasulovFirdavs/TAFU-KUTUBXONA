...
function BookDetail() {
    ...
    const handleAddToLibrary = async () => {
        ...
        try {
            ...
            alert('Kitob kutubxonaga qo\'shildi!');
        } catch (err) {
            alert(t('common.error'));
        }
    };
        ...
        return (
            <div className="book-detail-page">
                <div className="container">
                    <div className="book-header glass" style={{ padding: '2rem' }}>
                        <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
                            <Skeleton type="image" width="280px" height="400px" />
                            <div style={{ flex: 1, minWidth: '300px' }}>
                                <Skeleton type="title" width="70%" height="40px" />
                                <Skeleton type="text" width="40%" height="24px" style={{ margin: '1rem 0' }} />
                ...
                <div className="book-header glass">
                    ...
                    <div className="book-main-info">
                        ...
                        <div className="book-author">
                            <strong>{t('book_detail.author')}:</strong> {book.author_name || 'Noma\'lum'}
                        </div>
